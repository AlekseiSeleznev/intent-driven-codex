...
<p align="center">
  <img alt="Версия" src="https://img.shields.io/badge/version-v0.1.4-blue">
...
`v0.1.4` включает усиленный жизненный цикл с Matt `grill-with-docs` и `tdd`, а также проверку артефактов через Claude, настройки на уровне сессии, автоматические контрольные точки, отчеты о стоимости проверки Claude и исправления документации/установки от 2026-05-30:
...
по стоимости проверки Claude и исправления по validation report уже заархивированы. В репозитории есть канонические
...
Текущий выпуск: `v0.1.4`. См. [`CHANGELOG.md`](CHANGELOG.md).
