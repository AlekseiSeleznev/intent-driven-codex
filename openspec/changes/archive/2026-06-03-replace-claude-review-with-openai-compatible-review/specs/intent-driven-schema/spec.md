...
- **GIVEN** OpenAI-compatible artifact review is enabled and has produced tracked review reports for a change
...
- **GIVEN** a session overlay configures automatic git checkpointing or provider-neutral artifact review settings
