...
- `.codex/session/openspec-session.json` — ignored non-secret Codex session overlay for git checkpoint mode and Claude review settings.
...
The schema lifecycle does not add Claude review as an artifact. Instead, Codex
prompts/skills may call the project-local `scripts/openspec-claude-review`
helper after an artifact is generated when `.codex/openspec-claude-review.json`
