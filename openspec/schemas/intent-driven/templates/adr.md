...
<!-- List new top-level adr/NNNN-*.md files created, their status, and the decision they capture. Use `- None` when no durable ADR was created. -->
- None
...
## No ADR Needed
<!-- If no durable ADR is needed, explain why. Otherwise use `- N/A`. -->
- N/A
