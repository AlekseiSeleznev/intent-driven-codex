...
## Purpose
Defines the project-local `intent-driven` schema and how schema instructions guide Codex through proposal, specs, design, ADR, tasks, apply, and persistent project context.
