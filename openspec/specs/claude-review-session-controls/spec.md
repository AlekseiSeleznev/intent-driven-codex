# claude-review-session-controls Specification

## Purpose
TBD - created by archiving change add-default-git-automation-and-claude-session-controls. Update Purpose after archive.
## Requirements
