...
The workflow MUST require a git checkpoint after each OpenSpec lifecycle state change before a dependent lifecycle phase proceeds, including `grill.md`, `design-review.md`, and `test-plan.md` gates.
