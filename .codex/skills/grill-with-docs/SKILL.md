...
Stress-test a proposal, design, or plan against available documents and code. In intent-driven projects, write the result into `openspec/changes/<change>/review.md` when the `review` artifact is being created.
...
- `openspec/changes/<change>/review.md` when it already exists
...
- If review reveals artifact changes, propose exact artifact updates and record whether they were integrated in `review.md`.
