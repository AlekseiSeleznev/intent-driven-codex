...
4. **Create artifacts in sequence until apply-ready**
   ...
   a. **For each artifact that is `ready` (dependencies satisfied)**:
      ...
      - Expose the checkpoint boundary. If batch checkpointing was not explicitly pre-approved, stop here and recommend continuing with `/opsx:continue <name>`
...
**Guardrails**
- Fast-forward does not remove checkpoint discipline: each artifact boundary must be visible, and git mutations still require explicit approval.
