...
- Check tasks, requirements, scenarios, design decisions, grill/design-review resolutions, ADR constraints, OpenAI-compatible artifact review reports when configured/present, and RED/GREEN test-plan evidence.
