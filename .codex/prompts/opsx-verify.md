...
- Check tasks, requirements, scenarios, design decisions, grill/design-review resolutions, ADR constraints, and RED/GREEN test-plan evidence.

Output:
- Completeness: task completion and requirement coverage.
- Correctness: implementation evidence for requirements/scenarios.
- Coherence: design, review, ADR, and test-plan adherence.
