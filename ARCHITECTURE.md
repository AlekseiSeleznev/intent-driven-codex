...
- `adr/0004-adopt-mandatory-review-and-test-plan-gates.md` — expands the
  lifecycle with mandatory `review.md` and `test-plan.md` gates.
...
`review.md` records mandatory `grill-with-docs` review after design and before
ADR. `test-plan.md` records TDD or the strongest verification-first substitute
after ADR and before tasks.
