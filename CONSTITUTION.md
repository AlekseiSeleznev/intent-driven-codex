...
| --- | --- | --- | --- | --- |
| Polza.ai review provider | Optional OpenAI-compatible artifact review smoke/integration checks | HTTPS API, base URL `https://polza.ai/api/v1` | `POLZA_AI_API_KEY` | Real key value lives only in `.secrets.local.env` or local environment |
