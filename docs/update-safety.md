...
skills require a user-facing `## Artifact Review` block after each reviewer
...
the disposition for findings before checkpointing. Do not checkpoint while any artifact reviewer finding is unhandled.
