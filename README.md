...
`v0.1.5` includes the hardened Matt `grill-with-docs`/`tdd` lifecycle, Claude review/session/checkpoint controls, and the OpenSpec 1.4.0 auto-repair tooling hardening archived on 2026-06-02:
...
- regression checks for same-root install safety, help/version shim no-ops, source-vs-installed doc aliases, and stale real OpenSpec paths.
...
cost reporting, validation-report documentation fixes, and OpenSpec 1.4.0 auto-repair tooling hardening have all been archived. The repository contains canonical
...
Current release: `v0.1.5`. See [`CHANGELOG.md`](CHANGELOG.md).
