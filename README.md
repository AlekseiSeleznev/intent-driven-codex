...
`v0.1.4` includes the hardened Matt `grill-with-docs`/`tdd` lifecycle plus the Claude review, session-control, automatic checkpoint, cost-reporting, and documentation/install fixes added on 2026-05-30:
...
cost reporting, and validation-report documentation fixes have all been archived. The repository contains canonical
...
| Archived changes | `openspec/changes/archive/2026-05-24-implement-intent-driven-codex-template/`<br>`openspec/changes/archive/2026-05-24-add-codex-goal-guidance/`<br>`openspec/changes/archive/2026-05-25-add-project-constitution/`<br>`openspec/changes/archive/2026-05-26-formalize-project-context-architecture/`<br>`openspec/changes/archive/2026-05-28-add-mandatory-review-and-tdd-gates/`<br>`openspec/changes/archive/2026-05-28-harden-mandatory-grill-and-tdd-gates/`<br>`openspec/changes/archive/2026-05-30-add-claude-artifact-review/`<br>`openspec/changes/archive/2026-05-30-add-default-git-automation-and-claude-session-controls/`<br>`openspec/changes/archive/2026-05-30-add-claude-review-cost-summary/`<br>`openspec/changes/archive/2026-05-30-fix-validation-report-findings/` |
...
Current release: `v0.1.4`. See [`CHANGELOG.md`](CHANGELOG.md).
