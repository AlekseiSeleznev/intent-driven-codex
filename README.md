...
- optional provider-neutral artifact review through `scripts/openspec-artifact-review` with safe disabled defaults, Polza-compatible non-secret defaults, session-level `/opsx:review-*` controls, and structured cost-aware reports, and request-body provider routing for Polza/OpenRouter-compatible routers;
...
Current published release: `v0.1.8`. See [`CHANGELOG.md`](CHANGELOG.md).
